import{u as s,j as e,L as o}from"./index-BU-d_FoS.js";const n=()=>{const{id:i}=s(),t={title:"The Dopamine Reset: Escaping the Digital Loop",date:"Feb 16, 2026",category:"Mindset",content:`
        ...
        `};return e.jsx("div",{className:"blog-post-page",children:e.jsxs("article",{className:"blog-inner",children:[e.jsx(o,{to:"/blog",className:"back-link",children:"← Back to Knowledge Base"}),e.jsxs("div",{className:"post-meta",children:[e.jsx("span",{className:"post-category",children:t.category}),e.jsx("span",{className:"post-date",children:t.date})]}),e.jsx("h1",{className:"hero-title",children:t.title}),e.jsx("div",{className:"post-content",dangerouslySetInnerHTML:{__html:t.content}}),e.jsxs("div",{className:"blog-cta glass-card",children:[e.jsx("h3",{children:"Ready to take extreme responsibility?"}),e.jsx("p",{children:"Take the 3-minute Life Audit to see where you stand in Health, Wealth, and Mindset."}),e.jsx(o,{to:"/quiz",className:"cta-button primary-btn",children:"Start My Audit"})]})]})})};export{n as default};
