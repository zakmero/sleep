import{r as u}from"./index-BKS5OUBo.js";const d="https://smartadulting.com",p="Smart Adulting",t=(o,e,n)=>{if(!n)return;let i=document.head.querySelector(`meta[${o}="${e}"]`);i||(i=document.createElement("meta"),i.setAttribute(o,e),document.head.appendChild(i)),i.setAttribute("content",n)},c=o=>{let e=document.head.querySelector('link[rel="canonical"]');e||(e=document.createElement("link"),e.setAttribute("rel","canonical"),document.head.appendChild(e)),e.setAttribute("href",o)},h=({title:o,description:e,keywords:n,canonicalPath:i="/",imagePath:r="/hero-avatar.png",type:a="website"})=>(u.useEffect(()=>{const s=`${d}${i}`,l=`${d}${r}`;document.title=o,t("name","description",e),t("name","keywords",n),t("property","og:title",o),t("property","og:description",e),t("property","og:type",a),t("property","og:url",s),t("property","og:image",l),t("property","og:site_name",p),t("name","twitter:card","summary_large_image"),t("name","twitter:title",o),t("name","twitter:description",e),t("name","twitter:image",l),c(s)},[o,e,n,i,r,a]),null),g=[{title:"Dopamine Reset for Better Sleep and Focus",slug:"dopamine-reset-for-better-sleep-and-focus",content:`
    ...
    `,featuredImage:"/nih.png",metaTitle:"Circadian Anchors for Better Sleep Consistency | Smart Adulting",metaDescription:"Learn the three circadian anchors that quickly improve sleep consistency and daytime energy.",keyword:"circadian rhythm",excerpt:"Use wake-time, light exposure, and meal timing anchors to stabilize sleep and daytime alertness.",category:"Health",publishedAt:"2026-03-22"}],y=o=>g.find(e=>e.slug===o);export{h as S,g as b,y as g};
